...
RcppExport SEXP _abmAnimalMovementMES_cpp_check_intersection(SEXP originSEXP, SEXP targetSEXP, SEXP fence_x1SEXP, SEXP fence_x2SEXP, SEXP fence_y1SEXP, SEXP fence_y2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _abmAnimalMovementMES_cpp_cycle_draw(SEXP TIMESEXP, SEXP ASEXP, SEXP MSEXP, SEXP PHISEXP, SEXP TAUSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _abmAnimalMovementMES_cpp_get_values(SEXP MATRIXSEXP, SEXP XLOCSSEXP, SEXP YLOCSSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _abmAnimalMovementMES_cpp_max(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _abmAnimalMovementMES_cpp_min(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<double> >::type x(xSEXP);
...
RcppExport SEXP _abmAnimalMovementMES_cpp_sample_options(SEXP WSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _abmAnimalMovementMES_cpp_vonmises(SEXP NSEXP, SEXP MUSEXP, SEXP KAPPASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_abmAnimalMovementMES_cpp_abm_simulate", (DL_FUNC) &_abmAnimalMovementMES_cpp_abm_simulate, 42},
    {"_abmAnimalMovementMES_cpp_check_intersection", (DL_FUNC) &_abmAnimalMovementMES_cpp_check_intersection, 6},
    {"_abmAnimalMovementMES_cpp_cycle_draw", (DL_FUNC) &_abmAnimalMovementMES_cpp_cycle_draw, 5},
    {"_abmAnimalMovementMES_cpp_get_values", (DL_FUNC) &_abmAnimalMovementMES_cpp_get_values, 3},
    {"_abmAnimalMovementMES_cpp_max", (DL_FUNC) &_abmAnimalMovementMES_cpp_max, 1},
    {"_abmAnimalMovementMES_cpp_min", (DL_FUNC) &_abmAnimalMovementMES_cpp_min, 1},
...
RcppExport void R_init_abmAnimalMovementMES(DllInfo *dll) {
